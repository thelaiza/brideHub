      ...
      <div className="bg-card/80 backdrop-blur-xl border border-border/60 shadow-2xl rounded-3xl w-full max-w-md p-8 sm:p-10 space-y-8 animate-fade-in">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="space-y-1">
            <h2 className="text-xl font-semibold text-foreground font-display">Bem-vinda(o)!</h2>
            <p className="text-xs text-muted-foreground">Entre para continuar organizando o seu grande dia.</p>
          </div>
        </div>
        ...
        >
          <svg className="size-5" viewBox="0 0 24 24">
            ...
            <path
              fill="#FBBC05"
              d="M5.5 14.8c-.2-.7-.4-1.5-.4-2.3s.2-1.6.4-2.3L1.8 7.3C.7 9.5 0 10.7 0 12s.7 2.5 1.8 4.7l3.7-2.9z"
            />
            <path
              fill="#34A853"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className="w-full px-4 py-3 bg-muted/50 border border-border rounded-2xl text-sm text-foreground focus:outline-none focus:border-ring transition-colors"
            />
          </div>
        ...
        <div className="text-center text-xs text-muted-foreground pt-2">
          Ainda não tem conta?{' '}
          <a href="#cadastro" onClick={(e) => { e.preventDefault(); alert('Tela de cadastro em breve!'); }} className="font-semibold text-primary hover:underline">
